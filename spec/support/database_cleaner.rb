...
RSpec.configure do |config|
  ...
  config.before(:each, type: :feature) do
    ...
    if driver_shares_db_connection_with_specs
      ...
      # For example, you may want to start the process by truncating all the tables, 
      # but then use the faster transaction strategy the remaining time. To accomplish this you can say:
      DatabaseCleaner.clean_with(:truncation, reset_ids: true)
